...
class L1Loss(nn.Module):
    ...
    def forward(self, network_output, gt):
        """
        Args:
            network_output (torch.Tensor): The predicted output.
...
class SSIMLoss(nn.Module):
    ...
    def __init__(self, window_size=11, size_average=True):
        ...
        self.channel = 1  # Default, will be updated in forward pass
        self.window = None  # Placeholder for the SSIM window
    ...
    def forward(self, img1, img2):
        ...
        Returns:
            loss (torch.Tensor): The computed SSIM loss.
        """
